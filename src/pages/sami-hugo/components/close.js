          ...
          <div className="py-12 md:py-20 -mx-20 px-20">
            <div className="md:flex justify-between items-center text-center md:text-left">
              ...
              <div className="md:max-w-[640px]">
                {/* Copy */}
                <h2
                  className="font-extrabold text-left text-5xl font-hkgrotesk font-extrabold text-slate-100 mb-6"
                  data-aos="fade-right"
                >
                  Bringing the industry closer to you and you closer to{" "}
              ...
              >
                <a
                  className="px-4 py-2 text-sm font-medium inline-flex items-center justify-center rounded-full leading-5 whitespace-nowrap transition duration-150 ease-in-out text-white bg-blue-500 hover:bg-blue-600 group shadow-sm"
                  href="/subscribe"
                >
                  Subscribe - Free{" "}
