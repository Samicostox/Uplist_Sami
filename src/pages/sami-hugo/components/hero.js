import Avatar01 from "../images/hero/avatar-01.jpg";
import Avatar02 from "../images/hero/avatar-02.jpg";
import Avatar03 from "../images/hero/avatar-03.jpg";
import Avatar04 from "../images/hero/avatar-04.jpg";
import Client01 from "../images/hero/soundcloud-logo.png";
import Client02 from "../images/hero/spotify-logo.webp";
import Client03 from "../images/hero/stripe-logo.png";
import Client04 from "../images/hero/skiddle-logo.png";

import iPhone from "../images/hero/iphone.png";
import iPhone2 from "../images/hero/iphone2.png";
        ...
        <div className="pt-16 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="relative max-w-xl mx-auto md:max-w-none text-center md:text-left flex flex-col md:flex-row">
            ...
            <div className="md:w-[640px] py-12 md:py-20 md:min-h-[480px]">
              {/* Copy */}
              <h1
                className="text-6xl font-extrabold text-left font-hkgrotesk text-slate-100 mb-6"
                data-aos="fade-right"
                data-aos-delay="100"
              >
                Artist booking{" "}
              ...
              <p
                className="text-lg text-slate-400 mb-8 text-left"
                data-aos="fade-right"
                data-aos-delay="200"
              >
                Restoring Sovereignty to musicians through innovation and
                personalisation
              </p>
              {/* Buttons */}
              <div
              ...
              >
                <div>
                  <a
                    className="px-4 py-2 text-sm font-medium inline-flex items-center justify-center rounded-xl leading-5 whitespace-nowrap transition duration-150 ease-in-out text-white bg-blue-500 hover:bg-blue-600 group shadow-sm"
                    href="/auth/sign-up"
                  >
                ...
                <div className="sm:flex sm:items-center sm:justify-center space-y-2 sm:space-y-0 sm:space-x-3">
                  ...
                  <div className="text-xs text-slate-500 font-medium">250+</div>
                </div>
              </div>
              {/* Press logos */}
              <div
              ...
              >
                <div className="inline-flex flex-wrap items-center justify-center -my-2 -mx-4 md:-mx-6">
                  <div className="w-1/2 sm:w-auto flex justify-center py-2 px-4 md:px-6">
                    <img src={Client01} width={82} alt="Client 01" />
                  </div>
                  <div className="w-1/2 sm:w-auto flex justify-center py-2 px-4 md:px-6">
                    <img src={Client02} width={97} alt="Client 02" />
                  </div>
                  <div className="w-1/2 sm:w-auto flex justify-center py-2 px-4 md:px-6">
                    <img src={Client03} width={113} alt="Client 03" />
                  </div>
                  <div className="w-1/2 sm:w-auto flex justify-center py-2 px-4 md:px-6 sm:-mt-2">
                    <img src={Client04} width={82} alt="Client 04" />
                  </div>
                </div>
              </div>
            </div>
