  ...
  return (
    <div className={formStyle.link_item_open}>
      <div className={formStyle.dropdown_icon_container} onClick={handleClose}>
        <img
          src={"/pictures/edit/down-arrow.svg"}
          className={formStyle.dropdown_icon}
          alt="close button"
        />
      </div>
      ...
      <div
        className={
          false ? formStyle.edit_container_close : formStyle.edit_container
        }
      >
        <div className={formStyle.form_container}>
          <div className={formStyle.edit_label}>Link Text</div>
          ...
          <div className={formStyle.edit_label}>Link Url</div>
          <div className={formStyle.edit_link_container}>
        ...
        <div className={addStyle.buttons_container}>
          <div
            className="save_button bg-primary-color text-secondary-text-color rounded-l-[10px] text-center transition ease-in-out duration-200 hover:bg-primary-color-hover hover:cursor-pointer"
            onClick={handleSave}
          >
            Add
          </div>
          <div
            className="cancel_button bg-cancel-color text-cancel-text-color rounded-r-[10px] transition ease-in-out duration-200 hover:bg-cancel-color-hover hover:cursor-pointer"
            onClick={handleClose}
          >
            Cancel
          </div>
