...
function AddLinkForm(props) {
    ...
    const handleSave = async (e) => {
        ...
        try {
            ...
            const saveLinkResp = await UserService.addLink(formInput.linkText, "link", formInput.url, props.linkpageId , props.nextIndex);
        ...
        <div className={style.addModule_container}>
            <div className={module_form_class}>
                <div className={style.module_header}>
                    <h3>Add a link to your social media!</h3>
                </div>
